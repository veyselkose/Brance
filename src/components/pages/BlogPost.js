      ...
      <section className={styles.blogPost}>
        <main className={styles.main}>
          ...
          <div className={styles.content}>
            ...
            <br />
            <blockquote>
              Sed felis est, placerat a ornare vel, tempor id est. Phasellus ac
              urna vitae massa porttitor lacinia. Integer mollis, nulla pretium
              porttitor sagittis, urna nibh lobortis eros, ut lacinia.
            ...
            <p className={styles.paragraph}>
              ...
              adipisicing elit. Repellat incidunt dicta eius corporis iste,
              nihil nam atque. Deserunt vel, velit cum aut error nam. Unde in
              ipsa quos earum. Atque.
            </p>
          </div>
          ...
          <div className={styles.userCard}>
            ...
            <div className={styles.text}>
              ...
              <p className={styles.cardDesc}>
                Brance is by far the most amazing template out there! I
                literally could not be happier that I chose to buy this
                template! The world is a dangerous place to live; not because of
...
function CommentItem(props) {
  return (
    ...
    <p className={styles.commentContent}>
      ...
      augue ac ligula. Duis a enim vel mauris ultrices, leo.
    </p>
  </div>
  )
}
